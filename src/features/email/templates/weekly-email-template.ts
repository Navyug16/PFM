/**
 * PFM M14 Phase 3.5.2 — Weekly Email Template Renderer
 * Transforms a read-only EmailReportPayload into email-safe HTML for weekly dispatches.
 */
...
/**
 * Pure, deterministic weekly email HTML renderer.
 * 
 * STRICT RULES:
...
${insightsHtml}`
  ...
  return renderEmailLayout({
    ...
    subtitle: 'Your weekly spending & savings dispatch',
